          ...
          <div className="card border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                { icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>, name: 'Patient Care Services' }
              ].map((facility, index) => (
